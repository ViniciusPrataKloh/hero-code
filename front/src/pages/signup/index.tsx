            ...
            <div className="grid min-h-screen grid-cols-2">
                ...
                <div className="flex items-center justify-center">
                    <div className="bg-gray-50 bg-opacity-20 px-10 py-12 rounded-3xl shadow-2xl shadow-black flex flex-col">
                        ...
                        <Input type="email" placeholder="Insira seu nome" icon={<Person size={20}/>}/>
                            <Input type="email" placeholder="Insira seu email" icon={<EnvelopeSimple size={20}/>}/>
                            <Input type="password" placeholder="Insira sua senha" icon={<Key size={20}/>}/>
                        ...
                        <span className="mt-4 text-gray-50 text-xs">Já tem cadastro? <a className="font-bold text-white underline hover:cursor-pointer hover:text-gray-50">Voltar à Página Inicial</a></span>
                    </div>
                </div>
