...
export function Profile(){
  return(
    <section className="mt-8">
      <h2 className="-text-primary text-2xl font-medium mb-2">Editar perfil</h2>

      <div className="flex flex-col items-center justify-center">
        <div className="flex justify-center items-end">

          <div className="rounded-full bg-gradient-to-b -from-primary -to-secondary px-0.5 py-0.5">
            <img src="http://github.com/ViniciusPrataKLoh.png" className="rounded-full w-[140px] h-[140px] border-primary"/>
          </div>
